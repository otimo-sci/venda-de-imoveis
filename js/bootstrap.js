...
try {
    ...
    !function(t) {
        ...
        if (jQuery('script[src*="idxhome.com/service/resources/dist/wordpress"]').length)
            throw new Error("IHF is Loaded")
    }(),
    function(t) {
        "use strict";
        ...
        o.prototype.toggle = function(e) {
            ...
            if (!i.is(".disabled, :disabled")) {
                ...
                !a) {
                    ...
                    if (o.trigger(e = t.Event("show.bs.dropdown", r)),
